                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm- p-2">
                        <a class="btn btn-warning" href="<?= base_url('absensi') ?>"><i class="fas fa-undo-alt"></i> Back</a>
                      </div>
                    </div>
                    <div class="row mt-4">
                      <div class="col-sm">
                        <form action="<?= base_url('pegawai/add') ?>" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <small>(Biarkan kosong jika tidak diisi)</small>
                          </div>
