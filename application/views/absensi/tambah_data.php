                      ...
                      <div class="col-sm">
                        <form action="<?= base_url('absensi/add') ?>" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <?= form_error('kehadiran', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="jam_masuk">Jam masuk</label>
                            <input type="time" name="jam_masuk" id="jam_masuk" class="form-control" placeholder="Jam masuk....">
                            <?= form_error('jam_masuk', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="jam_keluar">Jam keluar</label>
                            <input type="time" name="jam_keluar" id="jam_keluar" class="form-control" placeholder="Jam keluar....">
                            <?= form_error('jam_keluar', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="jumlah_hadir">Jumlah Kehadiran</label>
                            <input type="text" name="jumlah_hadir" id="jumlah_hadir" class="form-control" placeholder="Jumlah kehadiran..">
